    ...
    var p = function (m, p) {
        ...
        TableTools.prototype = {
            ...
            _fnButtonDefinations: function (a, b) {
                ...
                var c = this, d = e(a).offset(), f = b._collection, j = d.left, d = d.top + e(a).outerHeight(),
                    i = e(n).height(), h = e(k).height(), o = e(n).width(), g = e(k).width();
                ...
                if (this.s.master) {
                    ...
                    e(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (c) {
                        var d = this.nodeName.toLowerCase() === "tr" ? this : e(this).parents("tr")[0], f = a.s.select,
                ...
                var b, c, d, f, j, i = [], h = "", g = this.s.dt, k, l = RegExp(a.sFieldBoundary, "g"),
